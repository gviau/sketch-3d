...
class ShaderDirect3D9 : public Shader {
    ...
    public:
        ...
        virtual bool SetUniformVector3Array(const string& uniform, const Vector3* values, int arraySize) { return false; }
        ...
        virtual bool SetUniformMatrix4x4Array(const string& uniform, const Matrix4x4* values, int arraySize) { return false; }
