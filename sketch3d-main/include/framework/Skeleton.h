...
public:
    ...
    INLINE size_t               GetNumberOfBones() const { return m_Bones.size(); }

private:
    map<string, AnimationState> m_AnimationStates;   /**< The animation that this skeleton can perform */
    BoneCacheMap_t              m_Bones; /**< List of bones of the skeleton */
    Bone_t*                     m_Root;  /**< Root bone of the skeleton */
    Matrix4x4                   m_GlobalInverseTransform;   /**< The global inverse transform of the skeleton */
