...
class SKETCH_3D_API AnimationState
{
    ...
    private:
        double                      m_DurationInTicks;   /**< The duration in ticks of the animation */  
        double                      m_TicksPerSeconds;   /**< How many ticks occur per second */
        VectorKey_t                 m_PositionKeys;  /**< Position keys for this animation stored per bones */
        QuaternionKey_t             m_RotationKeys;  /**< Rotation keys for this animation stored per bones */
        VectorKey_t                 m_ScaleKeys;     /**< Scale keys for this animation stored per bones */
};
